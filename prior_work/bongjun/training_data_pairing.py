...
train_data = np.load('../../data/npy_archive/first_half_train_X.npy')
train_labels = np.load('../../data/npy_archive/first_half_train_Y.npy')

val_data = np.load('../../data/npy_archive/first_half_val_X.npy')
val_labels = np.load('../../data/npy_archive/first_half_val_Y.npy')

ref_data = np.load('../../data/npy_archive/first_half_ref_X.npy')
ref_labels = np.load('../../data/npy_archive/first_half_ref_Y.npy')

train_data_norm = normalize_spectrograms(train_data)
val_data_norm = normalize_spectrograms(val_data)
ref_data_norm = normalize_spectrograms(ref_data)
...
# np.save('../../data/npy_archive/TL/train_pairs_data_left.npy', tr_left_final)
# np.save('../../data/npy_archive/TL/train_pairs_data_right.npy', tr_right_final)
# np.save('../../data/npy_archive/TL/train_pairs_labels.npy', train_pairs_labels_shuf)
# np.save('../../data/npy_archive/TL/val_pairs_data_left.npy', val_left_final)
# np.save('../../data/npy_archive/TL/val_pairs_data_right.npy', val_right_final)
# np.save('../../data/npy_archive/TL/val_pairs_labels.npy', val_pairs_labels)
