...
train_data_left = np.load('./data/train_pairs_data_left.npy')[:10]
train_data_right = np.load('./data/train_pairs_data_right.npy')[:10]
train_labels = np.load('./data/train_pairs_labels.npy')[:10]
val_data_left = np.load('./data/val_pairs_data_left.npy')[:10]
val_data_right = np.load('./data/val_pairs_data_right.npy')[:10]
val_labels = np.load('./data/val_pairs_labels.npy')[:10]
